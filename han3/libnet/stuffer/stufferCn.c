/*
 *  $Id: stuffer.c,v 1.1 2002/11/13 02:33:29 yudong Exp yudong $ 
 *
 *  Build a http query segment with keywords in it  
 *
 */
...
int main(int argc, char *argv[])
{
    ...
    char *nsfn = "dst.txt";
    char *srcfn = "src.txt";
    char *paybuf = "\xc3\xf7\xbb\xdb\x00";  /* "ming hui" in Chinese */
    char *pp;
    int jd = 0;
    int jn = 0;
    int js = 0;
