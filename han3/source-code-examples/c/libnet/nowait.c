/*
 *  $Id: nowait.c,v 1.1 2003/05/08 19:28:39 yudong Exp yudong $ 
 *  Program to kill TIME_WAIT state. 
 *  Usage:  
 *  nowait -p localport 
 *   gcc -static -o nowait nowait.c -lnet -lpcap 
 *
 */
...
int main(int argc, char *argv[])
{
    ...
    sprintf(filter, "dst port %d and tcp[13] & 1 != 0", sport); /* only FIN */
...
usage(char *name)
{
    printf("usage %s -p localport -i interface\n", name);
}
