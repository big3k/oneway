...
typedef struct syn_simple
{
	...
	in_addr dst;
	DWORD start_time;
} syn_simple, *syn_simple_ptr;

typedef struct syn_ack_ext
{
	ETH_REQUEST syn_ack;
	DWORD received_time;
} syn_ack_ext, *syn_ack_ext_ptr;

typedef struct syn_request {
	syn_simple synSimple;
	stack<syn_ack_ext> synAckPackets;
} syn_request, *syn_request_ptr;
#pragma pack()
